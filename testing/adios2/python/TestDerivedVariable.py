...
class TestDerivedVariable(unittest.TestCase):
    ...
    def test_01_create_write(self):
        with Stream(self.FILENAME, "w") as f:
            ...
            ds = f.io.define_derived_variable("derived/storedata", self.EXPR,
                                              DerivedVarType.StoreData)
            de = f.io.define_derived_variable("derived/expressionstring", self.EXPR,
                                              DerivedVarType.ExpressionString)
