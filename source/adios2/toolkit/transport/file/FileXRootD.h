 ...
 *
 * FileXRootD.h wrapper of XRootD client library functions for remote file I/O
 *
 *  Created on: Sep 27, 2023
 *      Author: Norbert Podhorszki, pnorbert@ornl.gov
 */

#ifndef ADIOS2_TOOLKIT_TRANSPORT_FILE_XROOTD_H_
#define ADIOS2_TOOLKIT_TRANSPORT_FILE_XROOTD_H_
...
/** File descriptor transport using the XRootD IO library */
class FileXRootD : public Transport
{

public:
    FileXRootD(helper::Comm const &comm);
...
#endif /* ADIOS2_TRANSPORT_FILE_XROOTD_H_ */
