...
BP5mtWriter::ComputationStatus
BP5mtWriter::IsInComputationBlock(AsyncWriteInfo *info, size_t &compBlockIdx)
{
...
void BP5mtWriter::AsyncWriteOwnData(AsyncWriteInfo *info,
...
int BP5mtWriter::AsyncWriteThread_EveryoneWrites(AsyncWriteInfo *info)
{
...
void BP5mtWriter::WriteData_EveryoneWrites_Async(format::BufferV *Data,
                                                 bool SerializedWriters)
{
    ...
    if (a->m_Comm.Rank() > 0)
    {
        a->m_Comm.Recv(
            ...
            "Chain token in BP5mtWriter::WriteData_EveryoneWrites_Async");
    }
    ...
    if (a->m_Comm.Size() > 1)
    {
        ...
        if (a->m_Comm.Rank() == a->m_Comm.Size() - 1)
        {
            a->m_Comm.Isend(&m_DataPos, 1, 0, 0,
                            ...
                            "BP5mtWriter::WriteData_EveryoneWrites_Async");
        }
        if (a->m_Comm.Rank() == 0)
        {
            a->m_Comm.Recv(
...
void BP5mtWriter::AsyncWriteDataCleanup_EveryoneWrites()
{
