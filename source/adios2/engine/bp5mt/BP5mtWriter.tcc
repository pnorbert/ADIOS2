 ...
 *
 * BP5mtWriter.tcc implementation of template functions with known type
 *
 */
#ifndef ADIOS2_ENGINE_BP5_BP5MTWriter_TCC_
#define ADIOS2_ENGINE_BP5_BP5MTWriter_TCC_
...
template <class T>
void BP5mtWriter::PutCommon(Variable<T> &variable, const T *values, bool sync)
{
...
template <class T>
void BP5mtWriter::PutCommonSpan(Variable<T> &variable,
...
#endif /* ADIOS2_ENGINE_BP5_BP5MTWriter_TCC_ */
