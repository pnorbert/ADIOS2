...
#ifndef ADIOS2_ENGINE_BP5_BP5MTWriter_H_
#define ADIOS2_ENGINE_BP5_BP5MTWriter_H_
...
class BP5mtWriter : public BP5Engine, public core::Engine
{
...
public:
     ...
     */
    BP5mtWriter(IO &io, const std::string &name, const Mode mode,
                helper::Comm comm);
...
private:
    ...
    */
    ...
    int EndStepAsync(AsyncWriteInfo *info);
...
#endif /* ADIOS2_ENGINE_BP5_BP5MTWriter_H_ */
